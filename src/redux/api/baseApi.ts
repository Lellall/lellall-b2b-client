...
export const baseApi = createApi({
  ...
  reducerPath: "api",
  endpoints: () => ({}),
  tagTypes: ["PRODUCTS", "ORDERS", "SHOPS", "TRANSACTION", "TEMPLATE", "INVENTORY", "MENU", "SUBSCRIPTION_PLAN", "SUPPLY_REQUEST", "VENDORS", "VatConfig", "ServiceFeeConfig", "BRANCHES", "BANK_DETAILS", "ATTENDANCE", "DEPARTMENT", "LEAVE", "ACCOUNTING", "PAYROLL", "VENDOR_INVOICES", "PAID_INVOICES", "WHATSAPP_MESSAGES", "CURRENCY", "LOUNGE_MEMBERS", "LOUNGE_WALKINS", "LOUNGE_BOTTLES", "LOUNGE_APPLICATIONS"],
});
