...
import { MemberDrawer } from '../members/components/member-drawer';
import { useGetDeletedMembersQuery } from '../../../../redux/api/perfume-store/members.api';
...
export const DeletedMembers: React.FC = () => {
  ...
  const { data: response, isLoading } = useGetDeletedMembersQuery(user?.privateStoreId || '', {
  ...
  return (
    <div className="p-6 lg:p-8 max-w-7xl mx-auto min-h-screen">
      ...
      <div className="mb-8 flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 mb-2 font-serif tracking-tight">Deleted Members</h1>
          <p className="text-gray-500 text-sm">Review soft-deleted members to reactivate them if necessary.</p>
        </div>
        <button
          onClick={() => alert('Invite flow: Direct applicants to your Store Application Portal.')}
