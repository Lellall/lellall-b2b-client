...
import { useAddBottleMutation } from '../../../../../redux/api/perfume-store/bottles.api';
...
export const AddBottleModal: React.FC<AddBottleModalProps> = ({ isOpen, onClose, membershipId, storeId }) => {
