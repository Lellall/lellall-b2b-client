...
import { useGetApplicationsQuery, useApproveApplicationMutation, useDeclineApplicationMutation, useConfirmPaymentMutation, useDeleteApplicationMutation } from '../../../../redux/api/perfume-store/applications.api';
  ...
  return (
    <div className="p-6 lg:p-8 max-w-7xl mx-auto min-h-screen">
      ...
      <div className="mb-8 flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
        ...
        <button
          onClick={() => navigate('/store/applications/new')}
