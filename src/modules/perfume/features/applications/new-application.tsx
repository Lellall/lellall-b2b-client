...
import { useSubmitApplicationMutation, useVerifyMembershipQuery, useRegisterGuestMutation } from '../../../../redux/api/perfume-store/applications.api';
...
export const NewApplication: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!user?.privateStoreId) {
      toast.error('Store ID is missing. Cannot submit application.');
      return;
    }
    ...
    try {
      ...
      await submitApplication({ storeId: user.privateStoreId, data: payload }).unwrap();
      
      toast.success('Membership Application submitted successfully!');
      navigate('/store/applications');
    } catch (err: any) {
      console.error(err);
  ...
  return (
    <div className="p-6 lg:p-8 max-w-5xl mx-auto min-h-screen">
      ...
      <div className="mb-8 flex items-center gap-4">
        <button 
          onClick={() => navigate('/store/applications')}
          ...
          <form onSubmit={handleSubmit} className="p-6 md:p-8">
            ...
            {currentStep === 'membership' && (
              <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                ...
                <div className="border-t border-gray-100 pt-6 mt-6">
                  <h4 className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-4">Store Preferences</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
