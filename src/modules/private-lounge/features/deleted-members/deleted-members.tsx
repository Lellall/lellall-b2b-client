...
import { useGetDeletedMembersQuery } from '../../../../redux/api/private-lounge/members.api';
...
export const DeletedMembers: React.FC = () => {
  ...
  const { data: response, isLoading } = useGetDeletedMembersQuery(user?.privateLoungeId || '', {
