...
import BranchUsers from "./components/branch-users";
...
const TabsLayout = ({ restaurantId }: TabsLayoutProps) => {
    ...
    return (
        <div className="mt-5">
            ...
            <div className="pt-4 mx-2">
                ...
                {activeTab === 'tab-6' && restaurantId && <div>
                    <BranchUsers restaurantId={restaurantId} />
                </div>}
            </div>
        </div>
    );
